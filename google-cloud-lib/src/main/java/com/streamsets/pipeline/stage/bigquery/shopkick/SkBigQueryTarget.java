...
public class SkBigQueryTarget extends BigQueryTarget {
    ...
    private static final Map<Field.Type, LegacySQLTypeName> DATA_TYPE_MAP =
            new HashMap<>();

    static {
        DATA_TYPE_MAP.put(Type.BOOLEAN, LegacySQLTypeName.BOOLEAN);
        DATA_TYPE_MAP.put(Type.BYTE_ARRAY, LegacySQLTypeName.BYTES);
        DATA_TYPE_MAP.put(Type.STRING, LegacySQLTypeName.STRING);
        DATA_TYPE_MAP.put(Type.SHORT, LegacySQLTypeName.INTEGER);
        DATA_TYPE_MAP.put(Type.LONG, LegacySQLTypeName.INTEGER);
        DATA_TYPE_MAP.put(Type.INTEGER, LegacySQLTypeName.INTEGER);
        DATA_TYPE_MAP.put(Type.DATE, LegacySQLTypeName.DATE);
        DATA_TYPE_MAP.put(Type.TIME, LegacySQLTypeName.TIME);
        DATA_TYPE_MAP.put(Type.DATETIME, LegacySQLTypeName.TIMESTAMP);
        DATA_TYPE_MAP.put(Type.FLOAT, LegacySQLTypeName.FLOAT);
        DATA_TYPE_MAP.put(Type.DOUBLE, LegacySQLTypeName.FLOAT);
